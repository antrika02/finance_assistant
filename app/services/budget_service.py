...
class BudgetAccessDeniedError(AppException):
    ...
    def __init__(self):
        super().__init__("You do not have permission to access this budget.")
...
class BudgetAlreadyExistsError(AppException):
    ...
    def __init__(self):
        super().__init__("Budget already exists for this category and month.")
...
class BudgetService:
    ...
    def get_budget_status(
        ...
        for row in result:
            ...
            percentage_used = float((spent / budget) * 100) if budget > 0 else 0.0
    ...
    def get_budget_alerts(
        ...
        for row in result:
            ...
            percentage_used = float((spent / budget) * 100)
